...
ONNX_PATH        = 'runs/train/yolov5l_ee_0.5/weights/best.onnx'       # 你的模型位置
ENGINE_PATH      = 'runs/train/yolov5l_ee_0.5/weights/best_lsq.onnx'  # 生成的 Engine 位置
...
QSetting.lsq_optimization_setting.collecting_device  = 'cpu'    # 训练过程的缓存数据位置
